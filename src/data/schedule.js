...
export const TIMETABLE = {
  Monday: [
    ...
    { period: 2, class: '中級3表現', short: '表現', color: '#8B5CF6' },
  ...
  Wednesday: [
    { period: 1, class: '中級3やりとり', short: 'やりとり', color: '#3B82F6' },
    { period: 2, class: '中級3表現 ⚠ 小テスト', short: '表現 テスト', color: '#8B5CF6' },
    { period: 3, class: '中級3理解', short: '理解', color: '#06B6D4' },
  ...
  Friday: [
    { period: 2, class: 'Intro to Economics (確認)', short: 'Econ 確認', color: '#EC4899' },
    { period: 3, class: 'Gym', short: 'Gym 💪', color: '#6B7280', optional: true },
    { period: 4, class: '運用やりとり³ (Debate)', short: 'Debate', color: '#F59E0B' },
  ],
};
