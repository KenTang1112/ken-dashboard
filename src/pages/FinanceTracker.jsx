// Moved from Finance.jsx — full income/expense tracker
// TODO: split income/expense models into src/data/finance-tracker.js for easier seeding
    ...
    <div className="page">
      <div className="page-header">
        <div>
          ...
          <p className="page-sub">Income &amp; expense ledger</p>
        </div>
      ...
      {tab === 'income' && (
        <div className="card">
          ...
          <div className="fin-table">
            <div className="fin-head fin-head-3"><span>Source</span><span>Amount (¥)</span><span>Frequency</span><span /></div>
            {income.map(r => (
      ...
      {tab === 'fixed' && (
        <div className="card">
          ...
          <div className="fin-table">
            <div className="fin-head fin-head-3"><span>Name</span><span>Amount (¥)</span><span>Frequency</span><span /></div>
            {fixed.map(r => (
              <div key={r.id} className="fin-row fin-row-3">
      ...
      {tab === 'variable' && (
        <div className="card">
          ...
          <div className="fin-table">
            <div className="fin-head fin-head-4"><span>Date</span><span>Category</span><span>Description</span><span>Amount (¥)</span><span /></div>
            {variable.map(r => (
